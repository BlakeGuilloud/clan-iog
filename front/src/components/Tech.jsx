      ...
      <div className="tech-item__content">
        <p><h2>[iOg]Defender</h2>
		  ...
		  <p>The following is a complete list of maps hosted by Clan iOg:</p>
						...
						<li>-4-TFTdeadlock		 -----------------------	DeadLock-tft		  </li>
